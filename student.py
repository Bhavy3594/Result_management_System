...
class StudentClass:
        ...
        try:
            if self.var_roll.get() == "":
                ...
                if row == None:
                    messagebox.showerror(
                        "Error",
                        "please select student from the list first",
                        parent=self.root,
                    )
                else:
    ...
    def clear(self):
        ...
        self.var_name.set(""),
        self.var_email.set(""),
        self.var_gender.set(value="Select Gender"),
        self.var_dob.set(""),
        self.var_contact.set(""),
        self.var_a_date.set(""),
        self.var_course.set(value="Select Course"),
        self.var_state.set(""),
        self.var_city.set(""),
        self.var_pin.set(""),
        self.txt_address.delete("1.0", END),
