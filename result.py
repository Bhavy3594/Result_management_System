...
class ResultClass:
    def __init__(self, root):
        ...
        lbl_name = Label(
            self.root, text="Name", font=("goudy old style", 20, "bold"), bg="white"
        ).place(x=50, y=160)

        lbl_course = Label(
            self.root, text="Course", font=("goudy old style", 20, "bold"), bg="white"
        ).place(x=50, y=220)
        ...
        btn_search.place(x=500, y=100, width=100, height=35)
        ...
        try:
            if self.var_name.get() == "":
                ...
                if row != None:
                    ...
                    per = (int(self.var_marks.get()) * 100) / int(
    ...
    def clear(self):
        self.var_roll.set(value="Select"),
        self.var_name.set(""),
        self.var_course.set(""),
        self.var_marks.set(""),
